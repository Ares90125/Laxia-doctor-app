      ...
      <card :title="$t('reset_password')">
        <form @submit.prevent="reset" @keydown="form.onKeydown($event)">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-7">
              <input v-model="form.email" :class="{ 'is-invalid': form.errors.has('email'), 'fulled-status' : form.email ? 'fulled-input': '' }" class="form-control" type="email" name="email" readonly>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-7">
              <input v-model="form.password" :class="{ 'is-invalid': form.errors.has('password'), 'fulled-status' : form.password ? 'fulled-input': '' }" class="form-control" type="password" name="password" id="password" >
          ...
          <div class="form-group row">
            ...
            <div class="col-md-7">
              <input v-model="form.password_confirmation" :class="{ 'is-invalid': form.errors.has('password_confirmation'), 'fulled-status' : form.password_confirmation ? 'fulled-input': '' }" class="form-control" type="password" name="password_confirmation" id="password_confirm">
