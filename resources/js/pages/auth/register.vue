      ...
      <div class="auth-form">
        <form @submit.prevent="register" @keydown="form.onKeydown($event)">
          ...
          <div class="form-group">
            ...
            <div>
              <input v-model="form.email" :class="{ 'is-invalid': form.errors.has('email'), 'fulled-status' : form.email ? 'fulled-input': '' }" class="form-control" type="text" name="email" v-bind:placeholder="$t('example or ID')" />
          ...
          <div class="form-group">
            ...
            <div class="pass-input-con">
              <input v-model="form.password" :class="{ 'is-invalid': form.errors.has('password'), 'fulled-status' : form.password ? 'fulled-input': '' }" class="form-control" type="password" name="password" id="password" v-bind:placeholder="$t('6文字以上で入力してください')" />
