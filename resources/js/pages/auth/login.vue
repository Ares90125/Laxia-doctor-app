    ...
    <div class="auth--wrapper">
      <div class="auth-form">
        <form @submit.prevent="login" @keydown="form.onKeydown($event)">
          <h2 class="auth-title">管理画面にログイン</h2>
          <!-- Email -->
          ...
          <div class="form-group">
            ...
            <div>
              <input v-model="form.password" :class="{ 'custom-pw-is-invalid-invalid': form.errors.has('password') }" class="custom-pw-form-control" type="password" name="password">
