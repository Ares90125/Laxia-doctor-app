...
<script>
  ...
  export default {
    ...
    methods: {
      setPhoto() {
        if (this.photo && this.$refs.changePhotoDropzone.dropzone.files.length == 0) {
      ...
      handleFileAdded(file) {
        if(this.$refs.changePhotoDropzone.dropzone.files.length > 1) {
            this.$refs.changePhotoDropzone.removeFile(this.$refs.changePhotoDropzone.dropzone.files[0]);
        }
